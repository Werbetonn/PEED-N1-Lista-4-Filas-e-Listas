...
numElementos = int(input("Digite o número de elementos para adicionar à fila: "))
...
removerElemento = input("Digite o elemento para remover da fila: ")
...
print("Após remover o elemento é:", fila.front())